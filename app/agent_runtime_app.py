...
# Ensure that the app directory is in sys.path for local module imports in serverless environments
...
class AgentEngineApp(AdkApp):
    def set_up(self) -> None:
        ...
        try:
            ...
            logging.warning(
                f"Failed to initialize Google Cloud Logging client: {e}. Falling back to standard logging."
            )
